...
const Skill = () => {
  const allSkill = [
    ...
    { id: "02", skillType: "web", skill: "MongoDB", expertLevel: 90 },

    { id: "05", skillType: "web", skill: "Meterial-UI", expertLevel: 60 },
    { id: "06", skillType: "web", skill: "Bootstrap", expertLevel: 80 },
    { id: "07", skillType: "web", skill: "CSS", expertLevel: 80 },
    ...
    // { id: "11", skillType: "tools", skill: "Web Pack", expertLevel: 70 },
    { id: "12", skillType: "tools", skill: "VSCode", expertLevel: 75 },
    { id: "13", skillType: "tools", skill: "Dev Tool", expertLevel: 60 },
    { id: "14", skillType: "tools", skill: "Figma", expertLevel: 50 },
  ];
